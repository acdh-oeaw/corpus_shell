...
//        });        
    ...
    module.setUpFakeXHR = function() {
        if (jasmine.Ajax !== undefined) {
            ...
            jasmine.Ajax.stubRequest('https://damasz.hephaistos.arz.oeaw.ac.at/corpus_shell//modules/fcs-aggregator/switch.php?version=1.2&operation=scan&scanClause=sense-en&x-context=apc_eng_002&x-format=json&x-dataview=kwic,title&sort=x&maximumTerms=10&responsePosition=0')
                    .andReturn({
                        "status": 200,
                        "contentType": 'text/json',
                        "responseText": module.fakeResponses['sense-en']
                    });
