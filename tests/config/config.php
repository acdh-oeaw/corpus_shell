 ...
 */
 ...
 /**
   ...
   */
  $dbConfigFile =            $docRoot . '../config/dbconfig.php';
  
  //ACDH's minerva
  $corpus3Root =             "http://minerva.arz.oeaw.ac.at/cs2/corpus_shell/modules/";
...
//$scanCollectionsTemplate = $fcsRoot . 'utils-php/templates/scan_collections.xml';
   ...
   */
  $switchUrl =               "http://127.0.0.1/" . $csRoot ."/modules/fcs-aggregator/switch.php";
  $switchUrlPublic =         "//" . $localhost . "/" . $csRoot ."/modules/fcs-aggregator/switch.php";
  $switchSiteName =          "Vienna Corpus of Arabic Varieties";
  $switchSiteLogo =          "//" . $localhost . "/" . $csRoot ."/scripts/style/logo_vicav.png";
   ...
   */
  $switchConfig =            $docRoot . "../config/switch.config";
  /**
