...
switch( state )
{
	case 0:
		...
		else if( info.src.charCodeAt( pos ) === 95 || info.src.charCodeAt( pos ) === 119 ) state = 7;
		else if( info.src.charCodeAt( pos ) === 65 ) state = 10;
		else if( info.src.charCodeAt( pos ) === 79 ) state = 11;
	...
	case 7:
		if( info.src.charCodeAt( pos ) === 95 || info.src.charCodeAt( pos ) === 119 ) state = 7;
		else state = -1;
		match = 7;
		match_pos = pos;
		break;
	...
	case 10:
		if( info.src.charCodeAt( pos ) === 78 ) state = 14;
		else state = -1;
		break;
	...
	case 12:
		if( info.src.charCodeAt( pos ) === 110 ) state = 15;
		else state = -1;
		break;
